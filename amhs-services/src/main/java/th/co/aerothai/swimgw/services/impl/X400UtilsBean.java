...
//    int status = X400ms.x400_ms_open(type, "CN=VTBBSWIM/OU=VTBB/O=VTBB/PRMD=THAILAND/ADMD=ICAO/C=XX/", "c=TH", 
//      "secret", "\"3001\"/URI+0000+URL+itot://172.16.21.134:3001", session_obj);
