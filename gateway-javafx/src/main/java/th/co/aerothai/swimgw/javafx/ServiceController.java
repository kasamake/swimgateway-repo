...
import th.co.aerothai.swimgw.services.amhs.RcvUtilsException;
...
public class ServiceController {
	...
	@FXML
	private Circle amhsToSwim1;
	
	@FXML
	private Circle amhsToSwim2;
	...
	private void initialize() {
		...
		amhsToSwim1.setFill(Color.RED);
		amhsToSwim2.setFill(Color.RED);
//		Button button = new Button("Red");
//		button.setOnAction(e -> amhsToSwim1.setFill(Color.red));
	}
...
//				connectionError.setTextFill(Color.GREEN);
				amhsToSwim1.setFill(Color.GREEN);
				amhsToSwim2.setFill(Color.GREEN);
			}
			amhsToSwimService();
